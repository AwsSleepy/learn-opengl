...
#pragma endregion
	...
	Material* myMaterial = new Material(&myShader, glm::vec3(0.3f, 0.3f, 0.3f), LoadImageToGPU("box.png", GL_RGBA, GL_RGBA, 0), LoadImageToGPU("specular.png", GL_RGBA, GL_RGBA, 1), 64);
#pragma endregion
